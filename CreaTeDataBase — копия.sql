...
INSERT INTO `shool`.`comments` (`id`, `content`, `tutorial_id`) VALUES ('4', 'There were 10 students in the tutorial', '4');
...
INSERT INTO `shool`.`comments` (`id`, `content`, `tutorial_id`) VALUES ('8', 'There were 14 students in the tutorial', '6');